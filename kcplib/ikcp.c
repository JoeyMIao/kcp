...
#if 0
	ikcp_qprint("rcvbuf", &kcplib->rcv_buf);
	printf("rcv_nxt=%lu\n", kcplib->rcv_nxt);
#endif
...
#if 0
	ikcp_qprint("queue", &kcplib->rcv_queue);
	printf("rcv_nxt=%lu\n", kcplib->rcv_nxt);
#endif

#if 1
//	printf("snd(buf=%d, queue=%d)\n", kcplib->nsnd_buf, kcplib->nsnd_que);
//	printf("rcv(buf=%d, queue=%d)\n", kcplib->nrcv_buf, kcplib->nrcv_que);
#endif
}
